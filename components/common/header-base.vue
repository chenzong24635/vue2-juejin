<template>
  <header class="header">
    <div id="header-base">
      <div class="container">
        <div class="logo">
          <img :src="`${$utils.svgUrl}logo.a7995ad.svg`" alt="">
        </div>
        <nav class="navs">
          <ul class="navs-left">
          ...
          <ul class="navs-right">
            <li class="navs-right-item" style="flex:1">
              <div  :class="['search', isSearchFocus ?'search-focus': '']">
                <input
                  ...
                  placeholder="搜索掘金"
                >
                <img :src="`${$utils.svgUrl}${isSearchFocus ? 'juejin-search-icon-focus.470748c.svg':'juejin-search-icon.6f8ba1b.svg'}`" alt="">
              </div>
            </li>
            ...
            <li v-if="isLogin" class="navs-right-item">
              <img :src="`${$utils.svgUrl}juejin-search-icon.6f8ba1b.svg`" alt="">
            <li @click="showWriteBox" v-if="!isLogin" class="navs-right-item navs-right-line">
              <img :src="`${$utils.svgUrl}submit-icon.53f4253.svg`" alt="">
              <span>写文章</span>
...
export default {
  ...
  created () {
    ...
    console.log(this.$utils.svgUrl);
  },
  methods: {
    searchFocus(bool) {
      this.isSearchFocus = bool
      console.log(1);
    },
